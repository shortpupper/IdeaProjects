...
public class SaveEXP extends CommandBase implements TabCompleter, Listener {

    public SaveEXP(WOKS plugin) {
        super("savexp");
        Bukkit.getPluginManager().registerEvents(this, plugin);

        plugin.getCommand("savexp").setExecutor(this);
        plugin.getCommand("savexp").setTabCompleter(this);
    }
